...
const printType = (0, _env.withEnv)((env, rawType) => {
  ...
  switch (type.kind) {
    ...
    case ts.SyntaxKind.TypeLiteral:
      return _index.default.declarations.interfaceType(type);
    ...
    case ts.SyntaxKind.TypeOperator:
      switch (type.operator) {
        ...
        default:
          console.log(`"NO PRINT IMPLEMENTED: TypeOperator ${ts.SyntaxKind[type.operator]}"`);
          return `"NO PRINT IMPLEMENTED: TypeOperator ${ts.SyntaxKind[type.operator]}"`;
      }
