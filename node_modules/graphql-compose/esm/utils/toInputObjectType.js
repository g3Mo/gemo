...
import { GraphQLObjectType, GraphQLInterfaceType, isInputType, GraphQLUnionType, GraphQLList, GraphQLNonNull } from '../graphql';
...
export function convertInputObjectField(field, opts, schemaComposer) {
  ...
  if (!isInputType(fieldType)) {
    if (fieldType instanceof GraphQLObjectType || fieldType instanceof GraphQLInterfaceType) {
      ...
      const tc = fieldType instanceof GraphQLObjectType ? schemaComposer.createObjectTC(fieldType) : schemaComposer.createInterfaceTC(fieldType);
